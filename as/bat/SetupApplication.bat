...
:: Android packaging
set AND_CERT_NAME="Samsung-InAppPurchase"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SamsungInAppPurchase.p12
...
set IOS_PROVISION=cert\SamsungInAppPurchase.mobileprovision
...
set APP_ID=air.SamsungInAppPurchase

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SamsungInAppPurchase
